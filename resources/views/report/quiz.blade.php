...
(function() {
    ...
    let individual_pass_count = {{ $pass_count }}
    let individual_fail_count = {{ $fail_count }}
    let group_pass_count = {{ $group_pass_count }}
    let group_fail_count = {{ $group_fail_count }}

    let individualPassingRate = 0
    let individualFailingRate = 0
    let groupPassingRate = 0
    let groupFailingRate = 0
